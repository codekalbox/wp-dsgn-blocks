...
class Feedback {
	...
	private function __construct() {
		...
		add_action( 'wp_ajax_pb_handle_feedback_action', array( $this, 'send' ) );
	}
	...
	public static function send() {
		...
		$api_url = 'https://feedback.premiumblocks.io/wp-json/feedback/v2/add';
	...
	public function create_popup() {
		...
		$plugin_data = get_plugin_data( PREMIUM_BLOCKS_FILE );

		?>
			<div class="pb-deactivation-popup hidden" data-type="wrapper" data-slug="<?php echo $plugin_data['TextDomain']; ?>">
				<div class="overlay">
					...
					<div class="body">
						...
						<section class="messages-wrap">
							<p><?php echo __( 'Would you quickly give us your reason for doing so?', 'premium-blocks-for-gutenberg' ); ?></p>
						</section>
						<section class="options-wrap">
							<label>
								<input type="radio" name="feedback" value="temp">
							<?php echo __( 'Temporary deactivation.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="setup">
							<?php echo __( 'Set up is too difficult.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="e-issues">
							<?php echo __( 'Causes issues with Gutenberg Editor.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="documentation">
							<?php echo __( 'Lack of documentation.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="features">
							<?php echo __( 'Not the features I wanted.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="better-plugin">
							<?php echo __( 'Found a better plugin.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="incompatibility">
							<?php echo __( 'Incompatible with theme or plugin.', 'premium-blocks-for-gutenberg' ); ?>
							</label>
							<label>
								<input type="radio" name="feedback" value="maintenance">
							<?php echo __( 'Other..', 'premium-blocks-for-gutenberg' ); ?>
							</label>
						</section>
						<section class="messages-wrap hidden" data-feedback>
							<p class="hidden" data-feedback="setup"><?php echo __( 'What was the difficult part?', 'premium-blocks-for-gutenberg' ); ?></p>
							<p class="hidden" data-feedback="e-issues"><?php echo __( 'What was the issue?', 'premium-blocks-for-gutenberg' ); ?></p>
							<p class="hidden" data-feedback="documentation"><?php echo __( 'What can we describe more?', 'premium-blocks-for-gutenberg' ); ?></p>
							<p class="hidden" data-feedback="features"><?php echo __( 'How could we improve?', 'premium-blocks-for-gutenberg' ); ?></p>
							<p class="hidden" data-feedback="better-plugin"><?php echo __( 'Can you mention it?', 'premium-blocks-for-gutenberg' ); ?></p>
							<p class="hidden" data-feedback="incompatibility"><?php echo __( 'With what plugin or theme is incompatible?', 'premium-blocks-for-gutenberg' ); ?></p>
							<p class="hidden" data-feedback="maintenance"><?php echo __( 'Please specify:', 'premium-blocks-for-gutenberg' ); ?></p>
						</section>
						...
						<section class="messages-wrap hidden" data-feedback>
							<p><?php echo __( 'Would you like to share your e-mail with us so that we can write you back?', 'premium-blocks-for-gutenberg' ); ?></p>
						</section>
						<section class="options-wrap hidden" data-feedback>
							<label>
								<input type="checkbox" name="anonymous" value="1">
							<?php echo __( 'No, I\'d like to stay anonymous', 'premium-blocks-for-gutenberg' ); ?>
							</label>
						</section>

						<section class="buttons-wrap clearfix">
							<button class="pb-deactivate-btn" data-action="deactivation"><?php echo __( 'Deactivate', 'premium-blocks-for-gutenberg' ); ?></button>
						</section>
					</div>
	...
	private static function collect_wordpress_data( $detailed = true ) {
		...
		$current_plugin = get_plugin_data( PREMIUM_BLOCKS_FILE );
		...
		$data = array(
			'deactivated_plugin' => array(
				...
				'install' => 'Activation: ' . get_option( 'pb_install_time' ),
