  ...
  */
  ...
  public function get_display_conditions($post_meta): string {
    ...
    foreach($conditions as $index => $condition) {
      // Get the labels
      if (array_key_exists($condition['condition'], $conditions_map)) {
        $condition_label = $conditions_map[$condition['condition']];
      } else if ( isset($condition['condition']) ) {
        $condition_label = $condition['condition'];
      } else {
        $condition_label = '';
      }
      $include_label = $include_map[$condition['include']];
