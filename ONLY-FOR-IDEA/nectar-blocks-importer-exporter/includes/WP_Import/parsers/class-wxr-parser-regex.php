    ...
    if ( $fp ) {
      while ( ! $this->feof( $fp ) ) {
        ...
        if ( $in_multiline && ! $is_tag_line ) {
          // https://core.trac.wordpress.org/ticket/32320
          // For really long "lines", which are really byte chunks, they were adding a \n for some reason.
          // I have 0 idea why someone thought this would be a good idea. May God have mercy on their soul.
          // This was adding random \n's to our CSS and blocks on import
